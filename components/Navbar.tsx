...
//     <NavigationMenu className="flex min-w-screeen mx-auto bg-red-600  h-28 border">
//       <NavigationMenuList className="bg-green-500 ">
//         <NavigationMenuItem>
...
//                   <a
//                     className="flex h-full w-full select-none flex-col justify-end rounded-md bg-gradient-to-b from-muted/50 to-muted p-6 no-underline outline-none focus:shadow-lg"
//                     href="/"
//                   >
            ...
            <NavigationMenuContent>
              <ul className="grid gap-3 p-6 md:w-[400px] lg:w-[500px] lg:grid-cols-[.75fr_1fr]">
                <li className="row-span-3">
                  <NavigationMenuLink asChild>
                    <a
                      className="flex h-full w-full select-none flex-col justify-end rounded-md bg-gradient-to-b from-muted/80 to-muted p-6 no-underline outline-none focus:shadow-lg"
                      href="/"
                    >
                      {/* <Icons.logo className="h-6 w-6" /> */}
                      <div className="mb-2 mt-4 text-lg font-medium">
                      ...
                      <p className="text-sm leading-tight text-muted-foreground">
                        To call or not to call an API. That is the question. Or
                        maybe To install shadcn ui or not to install shadcn ui.
